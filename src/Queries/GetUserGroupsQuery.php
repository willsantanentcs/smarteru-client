...
/**
 * Contains SmarterU\Queries\GetUserGroupsQuery
 *
...
/**
 * Represents a getUserGroups query made to the SmarterU API.
 */
class GetUserGroupsQuery extends BaseQuery {
    /**
    ...
    public function toXml(): string {
        ...
        $xml->addChild('Method', 'getUserGroups');
