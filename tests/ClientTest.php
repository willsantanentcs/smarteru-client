...
class ClientTest extends TestCase {
     ...
     * user identifier.
     */
    public function testGetUserQueryProducesCorrectInputForUserID() {
        $accountApi = 'account';
        $userApi = 'user';
        $client = (new Client())
            ->setAccountApi($accountApi)
     ...
     */
    public function testGetUserQueryProducesCorrectInputForEmail() {
        $accountApi = 'account';
        $userApi = 'user';
        $client = (new Client())
            ->setAccountApi($accountApi)
     ...
     * as the user identifier.
     */
    public function testGetUserQueryProducesCorrectInputForEmployeeID() {
        $accountApi = 'account';
        $userApi = 'user';
        $client = (new Client())
            ->setAccountApi($accountApi)
    ...
    public function testListUsersThrowsExceptionWhenFatalErrorReturned() {
        ...
        self::assertIsString($accountApi);
    }
     ...
     * does not return any errors.
     */
    public function testListUsersReturnsExpectedResult() {
        $accountApi = 'account';
        $userApi = 'user';
        $client = (new Client())
            ->setAccountApi($accountApi)
